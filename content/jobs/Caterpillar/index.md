...
- Collaborated in a team of 20 and with the Integrated Components Solutions AI Team on a year-long initiative to design and prepare for an LLM-powered data dashboard using high IQ telematic sensor data where engineers can perform data mining and analysis tasks
- Completed 12+ exploratory projects related to data handling and Generative AI to gain hands-on exposure working with Caterpillar telemetric data and LLMs available through open-source providers like Ollama
- Key contributions:
